...
<div class="row">
    <div class="col-md-4 offset-md-4 ">
        <div class="card bg-lg shadow text-secondary">
            ...
            <div class="card-body shadow">
                <form action="" method="post">
                  ...
                  <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="{{url('/login')}}" class=" text-dark"><u>Log in</u></a></p>
<br>
                </form>
                </div>
        </div> 
